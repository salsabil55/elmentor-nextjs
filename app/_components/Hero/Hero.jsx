...
function Hero() {
  return (
    <section className="relative opacity-90 lg:opacity-77 bg-[url(https://res.cloudinary.com/dahptqhed/image/upload/v1740401268/bg_mentor3_9ef612942e.jpg)] bg-cover bg-center bg-no-repeat">
